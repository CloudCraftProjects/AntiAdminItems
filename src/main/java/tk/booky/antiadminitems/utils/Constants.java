...
public final class Constants {
    ...
    public static final List<Material> ADMIN_ITEMS = Arrays.asList(Material.DEBUG_STICK, Material.COMMAND_BLOCK, Material.COMMAND_BLOCK_MINECART, Material.SPAWNER, Material.CHAIN_COMMAND_BLOCK, Material.REPEATING_COMMAND_BLOCK, Material.BARRIER, Material.JIGSAW, Material.STRUCTURE_BLOCK, Material.STRUCTURE_VOID, Material.BEDROCK, Material.END_PORTAL_FRAME);
